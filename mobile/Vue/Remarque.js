...
export default function Remarque({ route, navigation }) {
    ...
    const addRemarque = async () => {
        ...
        try {
            ...
            const uploadRes = await axios.post(`${API_BASE_URL}/uploadRemarquePhoto`, formData, {
                headers: {
            ...
            // 2. Création de la remarque avec l'URL Cloudinary
            const remarqueData = {
                floor: form.floor,
                ...
                building,
                task,
                image: uploadRes.data.avatarUrl,
            ...
            <SafeAreaView style={styles.container}>
                ...
                >
                    ...
                    {remarques.length > 0 ? (
                        ...
                        <Text style={styles.emptyMessage}>Aucune remarque pour ce jour là</Text>
                    )}
